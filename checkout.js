...
const FREE_SHIPPING_PRICE = 3000
...
const shippingPrice = total >= FREE_SHIPPING_PRICE ? 0.00 : SHIPPING_PRICE

const taxPrice = total * TAX_RATE

const sum = total * taxPrice + shippingPrice

 //! DOM'a sonuçları yazdırma
 ...
 document.getElementById("total").textContent = sumPrice.toFixed(2);
}
